...
def home():
    if request.method == 'POST':
        ...
        query = f"Use the provided {context} only to convert {symptoms} into one of the dictionary item then return that item, no explanantion , just one word answer."
        ...
        if symptoms == "Symptoms":
            ...
            # Get details for the first predicted disease (you can modify this as needed)
            ...
            return render_template('index.html', predicted_disease=top_diseases, dis_des=dis_des,
